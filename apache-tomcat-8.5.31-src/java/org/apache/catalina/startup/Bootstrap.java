...
public final class Bootstrap {
    ...
    private void initClassLoaders() {
        try {
            ...
            catalinaLoader = createClassLoader("server", commonLoader);//可在catalina.properties中配置
            sharedLoader = createClassLoader("shared", commonLoader);//可在catalina.properties中配置
        } catch (Throwable t) {
            handleThrowable(t);
